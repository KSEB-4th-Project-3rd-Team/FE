...
export default function InOutHistoryTableSkeleton() {
  return (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b">
                  <th className="text-left p-3 font-semibold"><Skeleton className="h-5 w-16" /></th>
              ...
              <tbody>
                {Array.from({ length: 10 }).map((_, index) => (
                  <tr key={index} className="border-b">
                    ...
                    <td className="p-3"><Skeleton className="h-5 w-20" /></td>
                    <td className="p-3 text-center"><Skeleton className="h-5 w-12 mx-auto" /></td>

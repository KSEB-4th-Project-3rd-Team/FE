                ...
                <table className="w-full text-sm text-center table-fixed">
                  <thead>
                    <tr className="border-b">
                      ...
                      <th className="p-3 font-semibold text-left w-[25%]">상품명</th>
                      <th className="p-3 font-semibold text-left w-[10%]">규격</th>
                      ...
                      <th className="p-3 font-semibold text-left w-[7%]">거래처</th>
